...
$celana = new Celana();
$data['items'] = $celana->getAllCelana();
  ...
  <section class="content">
    ...
    <div class="card">
              ...
              <tr>
                <td>
                  ...
                  if ($e['gender'] == 'laki-laki') {
                    echo sprintf('CM%03d', $e['id']);
                  } else {
                    echo sprintf('CW%03d', $e['id']);
                  }
                  ?>
                </td>
                <td>
                ...
                <td>
                  <a class="btn btn-secondary" href="<?= base_url; ?>/admin/item/celana/edit?id=<?php
                                                                                                if ($e['gender'] == 'laki-laki') {
                                                                                                  echo sprintf('CM%03d', $e['id']);
                                                                                                } else {
                                                                                                  echo sprintf('CW%03d', $e['id']);
      ...
      <div class="form-group d-flex align-items-center justify-content-between mb-4 ml-4">
        <a class="btn btn-primary" href="<?= base_url ?>/admin/item/celana/create"><i class="fas fa-user-plus"></i> Tambah
          Data</a>
      </div>
