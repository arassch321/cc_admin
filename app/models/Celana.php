...
class Celana
{
    ...
    public function getAllCelana()
    {
        ...
        SELECT id_celana_man AS id, nama, harga,'laki-laki' AS 'gender'
          FROM " . $this->table1 . ") AS a
        UNION 
        SELECT * FROM (
        SELECT id_celana_woman AS id, nama, harga,'perempuan' AS 'gender'
          FROM " . $this->table2 . ") AS b
        ");
        return $this->db->resultSet();
    }

    public function getCelanaById($data)
    {
        if ($data['identifier'] == 'CM') {
            $table = $this->table1;
            $col_id = 'id_celana_man';
        } else {
            $table = $this->table2;
            $col_id = 'id_celana_woman';
        }
    ...
    public function tambahCelana($data)
    {
    ...
    public function tambahCelanaEZ($data)
    {
        if ($data['gender'] == 'laki-laki') {
            $table = $this->table1;
        } else {
    ...
    public function updateDataCelana($data)
    {
        $bajoeh = $this->getCelanaById($data);
        if ($data['gender'] == "laki-laki") {
            $table = $this->table1;
            $table_ = $this->table2;
            $col_id = 'id_celana_man';
            $col_id_x = 'id_celana_woman';
        } else {
            $table = $this->table2;
            $table_ = $this->table1;
            $col_id = 'id_celana_woman';
            $col_id_x = 'id_celana_man';
        }
    ...
    public function deleteCelana($data)
    {
        $bajoeh = $this->getCelanaById($data);
