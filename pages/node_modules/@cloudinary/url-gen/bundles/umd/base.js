(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CloudinaryBaseSDK = {}));
    ...
    ***************************************************************************** */
    ...
    function createAutoGravityModel(gravity) {
        ...
        var values = gravityQualifier.qualifierValue.values.filter(function (v) { return v !== 'auto'; });
    ...
    function createGravityModel(gravity) {
        ...
        return createFocusOnGravityModel(gravity);
    }
    ...
    var Quality = { auto: auto$4, autoBest: autoBest, autoEco: autoEco, autoGood: autoGood, autoLow: autoLow, jpegmini: jpegmini, jpegminiBest: jpegminiBest, jpegminiHigh: jpegminiHigh, jpegminiMedium: jpegminiMedium };
     ...
     * @return {Qualifiers.Format.FormatQualifier}
     */
    function auto$3() { return new FormatQualifier('auto'); }
    /**
     * @summary qualifier
    ...
    var AnimatedFormat = { auto: auto$1, gif: gif, webp: webp, png: png };
    ...
    var SimpleEffectAction = /** @class */ (function (_super) {
        ...
        SimpleEffectAction.fromJson = function (actionModel) {
            var _a = actionModel, actionType = _a.actionType, level = _a.level;
            var effectType = ACTION_TYPE_TO_EFFECT_MODE_MAP[actionType] || actionType;
            // We are using this() to allow inheriting classes to use super.fromJson.apply(this, [actionModel])
            // This allows the inheriting classes to determine the class to be created
            var result = new this(effectType, level);
            return result;
        };
    ...
    var AccelerationEffectAction = /** @class */ (function (_super) {
        ...
        function AccelerationEffectAction() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        AccelerationEffectAction.prototype.rate = function (value) {
    ...
    var MakeTransparentEffectAction = /** @class */ (function (_super) {
        ...
        MakeTransparentEffectAction.fromJson = function (actionModel) {
            ...
            // We are using this() to allow inheriting classes to use super.fromJson.apply(this, [actionModel])
            // This allows the inheriting classes to determine the class to be created
            var result = new this(actionType, tolerance);
    ...
    var FadeoutEffectAction = /** @class */ (function (_super) {
        ...
        function FadeoutEffectAction() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        // We can't use EffectActionWithLength because this `length` is reversing the sign
        FadeoutEffectAction.prototype.duration = function (value) {
            return this.setLevel(-value);
        };
    ...
    var FadeInEffectAction = /** @class */ (function (_super) {
        ...
        function FadeInEffectAction() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        // We can't use EffectActionWithLength because this `length` is reversing the sign
        FadeInEffectAction.prototype.duration = function (value) {
            return this.setLevel(value);
        };
