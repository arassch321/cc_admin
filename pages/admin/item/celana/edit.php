             <?php
              ...
              $data['items'] = $celana->getCelanaById($cari);
              if ($cari['identifier'] == 'CM') {
              ...
              if (isset($_POST['save_record'])) {
                ...
                try {
                  if ($celana->updateDataCelana($dataInput) > 0) {
                    $_SESSION['success'] = 'Berhasil mengubah data celana "' . $dataInput['nama'] . '"';
